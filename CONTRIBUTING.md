...
### Para poder realizar un pull request al repositorio principal primero debes saber cómo están constituidas las ramas de este repo:
...
### 2. Realiza el commit con tus cambios, sigue las covenciones comentar los commits
...
### 3. Envía tu pull request para una revisión
```bash
